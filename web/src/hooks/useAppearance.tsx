...
function normalizeConfig(raw: AppConfig | null | undefined): AppConfig {
  ...
  return {
    ...
    audio_visualizer_mode: (["particles", "grid", "aurora", "radial", "bars", "city3d", "nebula3d", "terrain3d", "crystal3d"] as const).includes(base.audio_visualizer_mode as AudioVisualizerMode) ? base.audio_visualizer_mode as AudioVisualizerMode : "particles",
